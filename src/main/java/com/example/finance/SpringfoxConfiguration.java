...
public class SpringfoxConfiguration {
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Spring Boot REST API").description("Finance Management REST API")
    ...
    public SecurityConfiguration security() {
        return SecurityConfigurationBuilder.builder().clientId(clientID).clientSecret(secret).scopeSeparator(" ")
    ...
    private SecurityScheme securityScheme() {
        ...
        SecurityScheme oauth = new OAuthBuilder().name("spring_oauth").grantTypes(Arrays.asList(grantType)).build();
        return oauth;
    }
